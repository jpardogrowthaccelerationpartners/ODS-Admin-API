...
public class ReadApplicationTests
{
    ...
    public async Task GetApplications_ReturnsOkWithApplicationList()
    {
        ...
        var result = await ReadApplication.GetApplications(fakeGetAll, fakeGetDataStoreIds, validator, new CommonQueryParams(0, 25), null, null, null, null);
    ...
    {
        var validator = new ReadApplication.Validator();
        var result = validator.Validate("1,abc");
