...
public class CopyClaimSetHandlerTests
{
    ...
    public async Task Handle_WithValidRequest_ReturnsCreated()
    {
        ...
        A.CallTo(() => fakeGetApps.Execute(A<int>._)).Returns(new List<EdFi.Ods.AdminApi.V3.Infrastructure.ClaimSetEditor.Application>());
        ...
        var result = await CopyClaimSet.Handle(validator, fakeCopyCommand, fakeGetById, fakeGetResources, fakeGetApps, request, fakeHttpContext);
