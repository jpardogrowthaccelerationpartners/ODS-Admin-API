...
[TestFixture]
public class DeleteOdsInstanceDerivativeCommandTests
{
    private static SqlServerUsersContext CreateContext() =>
        new(new DbContextOptionsBuilder<SqlServerUsersContext>()
            .UseInMemoryDatabase(databaseName: $"DeleteOdsInstanceDerivative_{Guid.NewGuid()}")
            .Options);
    ...
    public void Execute_DeletesDerivative()
    {
        ...
        ctx.SaveChanges();
        new DeleteOdsInstanceDerivativeCommand(ctx).Execute(d.OdsInstanceDerivativeId);
    ...
    {
        using var ctx = CreateContext();
        Should.Throw<NotFoundException<int>>(() => new DeleteOdsInstanceDerivativeCommand(ctx).Execute(9999));
    }
}
