...
#nullable enable
    ...
    public class EditApiClientValidatorTests
    {
        ...
        {
            var model = new EditApiClientModelStub { Id = 0, Name = "ValidName", ApplicationId = 1, OdsInstanceIds = new[] { 1 } };
        ...
        {
            var model = new EditApiClientModelStub { Id = 1, Name = "", ApplicationId = 1, OdsInstanceIds = new[] { 1 } };
            var result = _validator.Validate(model);
        ...
        {
            var model = new EditApiClientModelStub { Id = 1, Name = "ValidName", ApplicationId = 0, OdsInstanceIds = new[] { 1 } };
            var result = _validator.Validate(model);
        ...
        {
            var model = new EditApiClientModelStub { Id = 1, Name = "ValidName", ApplicationId = 1, OdsInstanceIds = System.Array.Empty<int>() };
            var result = _validator.Validate(model);
        ...
        {
            var model = new EditApiClientModelStub { Id = 1, Name = "ValidName", ApplicationId = 1, OdsInstanceIds = null };
            var result = _validator.Validate(model);
            result.Errors.Any(x => x.PropertyName == nameof(model.OdsInstanceIds)).ShouldBeTrue();
        }
