...
{
    [Test]
    public async Task Handle_WithEditableClaimSetAndNoApps_ReturnsOk()
    {
        ...
        A.CallTo(() => fakeGetApps.Execute(1)).Returns(new List<EdFi.Ods.AdminApi.Infrastructure.ClaimSetEditor.Application>());
